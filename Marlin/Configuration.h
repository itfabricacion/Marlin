...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 60.34
  #define DEFAULT_bedKi 8.07
  #define DEFAULT_bedKd 300.91
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 412.31 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 80, 6500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -21.47, -19.75, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 1  // (mm) Comment out to use the last-measured height
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (9), (Y_MIN_POS), 5 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE          NEO_GBR // NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc.
