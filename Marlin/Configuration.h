...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  18.00,  22.20, 20.40 }
    #define DEFAULT_Ki_LIST {   0.50,   1.08, 0.50 }
    #define DEFAULT_Kd_LIST { 180.00, 114.00, 209.72 }
  #else
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 15, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -65, -5 }
...
#define HOMING_FEEDRATE_MM_M { (75*60), (75*60), (15*60) }
