...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  #define DEFAULT_AXIS_STEPS_PER_UNIT 0,  23.10 }
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 26.66, 26.66, 640, 224.6 }//{ 26.66, 26.66, 640, 224.6 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 15, 150 }
