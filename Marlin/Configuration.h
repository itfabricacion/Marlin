...
#define STRING_CONFIG_H_AUTHOR "(ITFAB)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ITPRO"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 106.665, 80, 400, 125.56 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 6500 }
...
#define HOMING_FEEDRATE_MM_M { (60*60), (60*60), (30*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS/2), (Y_MAX_POS), 3 }
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { (X_BED_SIZE/2), (Y_BED_SIZE), (2)}
  #define NOZZLE_CLEAN_END_POINT   { (X_BED_SIZE/2), (Y_BED_SIZE - 20), (2)}
