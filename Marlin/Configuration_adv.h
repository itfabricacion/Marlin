...
//
  ...
  #define HOTEND0_BETA                 4092    // Beta value
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH     670  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH  620  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define MONITOR_DRIVER_STATUS
    ...
    #define CURRENT_STEP_DOWN     100//50  // [mA]
