 ...
 */
  ...
  #define PROBING_MARGIN_LEFT 150//0//PROBING_MARGIN
  #define PROBING_MARGIN_RIGHT 230//80//PROBING_MARGIN
  #define PROBING_MARGIN_FRONT 210//60//PROBING_MARGIN
  #define PROBING_MARGIN_BACK 150//0//PROBING_MARGIN
#endif

#if EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL)
  // Override the mesh area if the automatic (max) area is too large
  #define MESH_MIN_X 50//MESH_INSET
  #define MESH_MIN_Y 130//MESH_INSET
  #define MESH_MAX_X X_BED_SIZE - 110//(MESH_INSET)
  #define MESH_MAX_Y Y_BED_SIZE - 50//(MESH_INSET)
#endif
 ...
 */
#define MINIMUM_STEPPER_POST_DIR_DELAY 5
#define MINIMUM_STEPPER_PRE_DIR_DELAY 5
